    ...
    <form class="col-lg-7 mt-3" method="POST" action="<?= base_url('feedback/komentar') ?>">
        <div class="form-group">
            <h4 class="font-weight-bold">Hallo, <?= $this->session->userdata('username'); ?><br>
                <h6>Selamat datang di Feedback<br>Kamu dapat memberikan komentarmu<br>mengenai menu, pelayanan, dan kenyamananmu disini.</h6>
        </div>
            ...
            <div class="col-md-16">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h6 class="card-subtitle">Dari semua pelanggan Kenangan senja</h6>
                    </div>
                    <?php foreach ($row->result() as $key => $data) { ?>
                        <div class="comment-widgets m-b-20">
                            <div class="d-flex flex-row comment-row">
                                <div class="p-2"><span class="round"><img src="<?= base_url(); ?>assets/img/avatar.png" alt="user" width="50"></span></div>
