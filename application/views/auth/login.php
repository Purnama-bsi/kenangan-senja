<body class="img js-fullheight" style="background-image: url(<?= base_url('/assets/images/bg1.jpg'); ?>);">
    <section class="ftco-section">
        <div class="container">
            <div class="row justify-content-center">

                <div class="col-md-6 text-center mb-5">
                    <img src="assets/img/senja.png" alt="logo" style="width: 220px; height: 130px; margin-bottom: -40px;">
                </div>
            </div>
